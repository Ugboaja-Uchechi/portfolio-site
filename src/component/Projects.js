    ...
    <>
      <section className="proj-section">
        ...
        <div className="flex-container grid-container">
          <div id="grid-column-2" className="flex-cover">
            <div className="seyi-div div-1">
              ...
              <div className="img">
                {/* <img src={VacayImage} alt="A girl smiling" className="width" /> */}
              </div>
              {/* <div className="content">
                <h3 className="project-title">Vacay Home</h3>
                <p>Vacay home is a rental site built with React, Ruby on Rails, Bootstrap, Jest, and CSS in which users can create reservations for vacation homes and create listings.</p>
          ...
          <div id="grid-column-3" className="flex-cover">
            <div className="seyi-div div-2">
              <div className="content">
              ...
              <div className="img-2">
                {/* <img src={SpaceImage} alt="A girl smiling" className="width" /> */}
              </div>
              {/* <div>
                <h3 className="project-title">Space Traveler's Hub</h3>
                <p>Space Traveler's Hub is a desktop web application built with React, Bootstrap, Jest, and, CSS that allow users to book rockets and join selected space missions.</p>
          ...
          <div id="grid-row-3" className="flex-cover">
            <div className="seyi-div div-3">
              <div className="content">
              ...
              <div className="img-3">
                {/* <img src={IpImage} alt="A girl smiling" className="width" /> */}
              </div>
            </div>
          </div>
          <div id="grid-row-4" className="flex-cover">
            <div className="seyi-div div-4">
              <div className="content">
              ...
              <div className="img-4">
                {/* <img src={UrlImage} alt="" className="width" /> */}
              </div>
            </div>
          </div>
        </div>
